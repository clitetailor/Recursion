...
int seq1sumtailrec(int para, int a0, int a1, int a2);

// Sequence 2: 1, 2, 3, 7, 13, 23, 43, 79, 145, ...

int seq2sumrec(int para);
int seq2sumtailrec(int para, int a0, int a1, int a2, int a3);

// Sequence 3:

int seq3sumrec(int para);
int seq3sumtailrec(int para, int a0, int a1, int a2, int a3);

// Sequence 4:

int seq4sumrec(int para);
int seq4sumtailrec(int para, int a0, int a1, int a2, int a3);
